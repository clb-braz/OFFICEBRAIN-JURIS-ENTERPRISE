    ...
    <div className="min-h-screen bg-dark-950 p-4 lg:p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-dark-400 text-sm">Gerencie suas preferências</p>
          </div>
        </div>
        {saved && (
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-64 flex-shrink-0">
          <nav className="bg-dark-900 rounded-xl border border-dark-800 p-2 space-y-1">
            {tabs.map((tab) => (
              <button
                key={tab.id}
        ...
        {/* Conteúdo */}
        <div className="flex-1 bg-dark-900 rounded-xl border border-dark-800 p-6">
          {/* Perfil */}
          {activeTab === 'perfil' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Meu Perfil</h2>
                <p className="text-sm text-dark-400">Informações da sua conta</p>
              </div>
              
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-dark-300 mb-1">Nome completo</label>
                  <input
                    type="text"
                    value={perfil.nome}
                ...
                <div>
                  <label className="block text-sm text-dark-300 mb-1">Número OAB</label>
                  <input
                    type="text"
                    value={perfil.oab}
          ...
          {activeTab === 'escritorio' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-dark-400">Informações da empresa</p>
              </div>
              
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="sm:col-span-2">
                  <label className="block text-sm text-dark-300 mb-1">Nome do escritório</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm text-dark-300 mb-1">CNPJ</label>
                  <input
                    type="text"
          ...
          {activeTab === 'notificacoes' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-dark-400">Configure como deseja receber alertas</p>
              </div>

              <div className="space-y-4">
                <h3 className="text-sm font-medium text-dark-300">Notificações por E-mail</h3>
                {[
                  ...
                  <label key={item.key} className="flex items-center justify-between p-3 bg-dark-800 rounded-lg cursor-pointer">
                    ...
                    <input
                      ...
                      className="w-5 h-5 rounded bg-dark-700 border-dark-600 text-blue-600 focus:ring-blue-500"
                    />
                  </label>
                ))}
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-dark-300">Notificações Push</h3>
                {[
          ...
          {activeTab === 'seguranca' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-dark-400">Altere sua senha</p>
              </div>

              <div className="space-y-4 max-w-md">
                <div>
                  <label className="block text-sm text-dark-300 mb-1">Senha atual</label>
                  <div className="relative">
                    <input
                      type={showPassword ? 'text' : 'password'}
                      value={seguranca.senhaAtual}
                      onChange={(e) => setSeguranca({ ...seguranca, senhaAtual: e.target.value })}
                      className="w-full px-3 py-2 pr-10 rounded-lg bg-dark-800 border border-dark-700 text-sm outline-none focus:border-blue-500"
                    />
                    <button
                      type="button"
                ...
                <div>
                  <label className="block text-sm text-dark-300 mb-1">Nova senha</label>
                  <input
                    type={showPassword ? 'text' : 'password'}
                ...
                <div>
                  <label className="block text-sm text-dark-300 mb-1">Confirmar nova senha</label>
                  <input
                    type={showPassword ? 'text' : 'password'}
          ...
          {activeTab === 'aparencia' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm text-dark-300 mb-2">Tema</label>
                  <div className="flex gap-3">
                    <button className="flex-1 p-4 rounded-lg border-2 border-blue-500 bg-dark-800">
                      <div className="w-full h-8 rounded bg-dark-950 mb-2"></div>
                      <p className="text-sm text-white">Escuro</p>
                    </button>
                    <button className="flex-1 p-4 rounded-lg border-2 border-dark-700 bg-dark-800 opacity-50">
                      <div className="w-full h-8 rounded bg-gray-200 mb-2"></div>
                      <p className="text-sm text-dark-400">Claro (em breve)</p>
                    </button>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'dados' && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-dark-400">Exporte ou limpe seus dados</p>
              </div>

              <div className="space-y-4">
                <div className="p-4 bg-dark-800 rounded-lg">
                  <h3 className="font-medium text-white mb-1">Exportar dados</h3>
                  <p className="text-sm text-dark-400 mb-3">Baixe todos os seus dados em formato JSON</p>
                ...
                <div className="p-4 bg-dark-800 rounded-lg border border-red-500/30">
                  ...
                  <p className="text-sm text-dark-400 mb-3">Ações irreversíveis</p>
